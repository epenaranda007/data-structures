describe('doublyLinkedList', function() {
  ...
  it('Add\'l: doubly-linkedlist should return a node from .previous property', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
    expect(doublyLinkedList.tail.previous.value).to.equal(4);
  });

  it('Add\'l: changing heads the new heads\'s previous property should be null', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
    doublyLinkedList.removeHead();
  ...
  it('Add\'l:  Add head should work', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
